...
var Human = function(name) {
  ...
  this.birthday = function(years) {
    this.age += parseInt(years);
    console.log(`Congratulations! ${this.name} is now ${this.age} years old!`)
  }
}
...
console.log(ari.age, ari.school);
...
/*
  Answer here:
we changed the talk method for blake,
but ari has the human prototype method for talk
