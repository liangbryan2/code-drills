...
$(function() {
  ...
  $(document).on("click", ".user-card", function(event) {
    ...
    if (localStorage.getItem("buttonColors")[index] === "1") {
      buttonColors = replaceChar(localStorage.getItem("buttonColors"), index, "0");
      localStorage.setItem("buttonColors", buttonColors);

    }
    else if (localStorage.getItem("buttonColors")[index] === "0") {
      buttonColors = replaceChar(localStorage.getItem("buttonColors"), index, "1");
      localStorage.setItem("buttonColors", buttonColors);
