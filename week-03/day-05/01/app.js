	...
	function getHeroes() {
      ...
      7.
        ...
        Hint: loop
			*/
			for (var i = 0; i < results.length; i++) {
				...
				*/
				var col = $("<div class='col-sm-12 col-md-6 col-log-6'>");
				/* 
        ...
        8.
          ...
          Hint: nested loop
			  */
				for (var j = 0; results[i].members[j]; j++) {
					/* 
					...
					*/
					...
					/* 
					  	...
					  	*/
					var image = $("<img class='hero-image'>");
					image.attr("src", results[i].members[j].image);
					/* 
					...
					*/
					...
					/* 
					  	...
					  	*/
					var name = $("<p>");
					name.text(results[i].members[j].name);
					/* 
						  ...
						  */
					var power = $("<p>");
					power.text(results[i].members[i].powers[results[i].members[i].powers.length - 1]);
					/* 
          9.
