...
var nestedArray1 = [[1,2], ["nested", ["Radio Flyer Wagon", "Chemistry Set", ["Joy Buzzer", "Yo-Yo"]]]];
var target;
// assign `target` the value of "Yo-Yo" using the `nestedArray` variable
// 
target = nestedArray1[1][1][2][1];
...
var nestedArray2 = ["Pop-Up Book", ["Stuffed Mickey Mouse", ["Beach Ball", "Sock Monkey"], "Buck Rogers Rocket Pistol"], "Microscope Set"];
var target2;
// assign `target` the value of "Sock Monkey" using the `nestedArray` variable
// 
target2 = nestedArray2[1][1][1];
